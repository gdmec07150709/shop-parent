...
public class ActivemqConfig {
    @Bean
    public Destination createOrderQueue(){
        Destination destination = new ActiveMQQueue("createOrderMessage");
        return destination;
    }
    @Bean
    public Destination createOrderTopic(){
        Destination destination = new ActiveMQTopic("createOrderMessageTopic");
        return destination;
    }
    /**
